/**
 * \file rmw_reply_packet_example.c
 *
 * \brief Example calls to build and fill read/modify/write reply packets.
 *
 ...
 * and fill RMAP read/modify/write reply packets.  It also contains calls to
...
void rmw_reply_packet_example()
{
	...
	fillPacketLenCalculated = RMAP_CalculateReadModifyWriteReplyPacketLength(1,
		4, 1);
	...
	pBuildPacket = RMAP_BuildReadModifyWriteReplyPacket(pReply, 1, target,
