/**
 * \file mk2_external_port.hpp
 *
 * \brief Represents an External Port on a Mk2 device.
 *
 ...
 *
 * Represents an External Port on a Mk2 device.
 *
...
#ifndef __DEVICE_MK2_EXTERNAL_PORT_CPP__
#define __DEVICE_MK2_EXTERNAL_PORT_CPP__
...
* Represents an External Port on a Mk2 device.
*/
class Mk2ExternalPort : public ExternalPort
{
public:
    /**
    * Default constructor. Initialise object to default state.
    */
    Mk2ExternalPort() : ExternalPort()
    {
    }
    ...
    *
    */
    Mk2ExternalPort(STAR_DEVICE_ID idOfOwningDevice,
               STAR_CFG_PORT_TYPE type,
               U8 portNum,
               PORT_STATUS_CONTROL statusControl) : ExternalPort(idOfOwningDevice,
                                                     type,
                                                     portNum,
                                                     statusControl)
    {
    ...
    /**
    * Copy constructor - to allow copies of Mk2ExternalPort objects to be made
    * when being passed by value in functions or returned by value from
    * functions.
    *
    */
    Mk2ExternalPort(const Mk2ExternalPort& portToCopyFrom) : ExternalPort()
    {
    ...
    /**
    * Overloaded assignment operator - to allow instances of Mk2ExternalPort
    * objects to have their contents assigned to each other.
    *
    */
    Mk2ExternalPort& operator=(const Mk2ExternalPort& portBeingAssigned)
    {
