/**
 * \file splt_config_port.hpp
 *
 * \brief Represents a Configuration Port on a SPLT device.
 *
 ...
 *
 * Represents a Configuration Port on a SPLT device.
 *
...
#ifndef __DEVICE_SPLT_CONFIG_PORT_CPP__
#define __DEVICE_SPLT_CONFIG_PORT_CPP__
...
* Represents a Configuration Port on a SPLT device.
*/
class SPLTConfigPort : public stardundee::com::starsystem::deviceconfig::mk2devices::pcie::PCIeConfigPort
{
public:
    /**
    * Default constructor. Initialise object to default state.
    */
    SPLTConfigPort() : PCIeConfigPort()
    {
    }
    ...
    *
    */
    SPLTConfigPort(STAR_DEVICE_ID idOfOwningDevice,
        STAR_CFG_PORT_TYPE type,
        U8 portNum,
        PORT_STATUS_CONTROL statusControl) : PCIeConfigPort(idOfOwningDevice,
    ...
    /**
    * Copy constructor - to allow copies of SPLTConfigPort objects to be
    * made when being passed by value in functions or returned by value from
    * functions.
    */
    SPLTConfigPort(const SPLTConfigPort& portToCopyFrom) : PCIeConfigPort()
    {
    ...
    /**
    * Overloaded assignment operator - to allow instances of SPLTConfigPort
    * objects to have their contents assigned to each other.
    *
    */
    SPLTConfigPort& operator=(const SPLTConfigPort& portBeingAssigned)
    {
