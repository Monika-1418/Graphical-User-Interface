/**
 * \file rmap_read_modify_write_reply_packet.hpp
 *
 * \brief Represents an RMAP read-modify-write reply packet.
 *
 ...
 *
 * Represents an RMAP read-modify-write reply packet.
 *
...
#ifndef __RMAP_READ_MODIFY_WRITE_REPLY_PACKET_CPP__
#define __RMAP_READ_MODIFY_WRITE_REPLY_PACKET_CPP__
...
* Represents an RMAP read-modify-write reply packet.
*/
class RMAPReadModifyWriteReplyPacket : public RMAPPacket
{
private:
    /**
    * Build an RMAP read-modify-write reply packet which can be sent to
    * respond to an RMAP read-modify-write command.
    *
    ...
    * @param dataLength The length in bytes of the data field, this can be at
    *                   most 4 bytes.
    ...
    */
    void *BuildReadModifyWriteReplyPacket(U8 *pInitiatorAddress,
                                 ...
                                 RMAP_PACKET *pPacketStruct, char alignment)
    {
        ...
        return RMAP_BuildReadModifyWriteReplyPacket(pInitiatorAddress,
...
public:
    ...
    */
    RMAPReadModifyWriteReplyPacket() : RMAPPacket()
    {
    ...
    * read-modify-write reply packet using the values provided.
    *
    * @param pInitiatorAddress  A pointer to the SpaceWire path or logical address
    *                           of the device to which the reply should be sent.
    * @param initiatorAddressLength The length of the initiator address.
    ...
    *
    */
    RMAPReadModifyWriteReplyPacket(U8 *pInitiatorAddress,
                                 unsigned long initiatorAddressLength,
                                 U8 targetAddress,
                                 RMAPStatus status,
                                 U16 transactionIdentifier,
                                 unsigned long dataLength,
                                 U8 *pData, char alignment)
    {
         ...
         * values provided */
        void *pPacket = BuildReadModifyWriteReplyPacket(pInitiatorAddress,
                                           initiatorAddressLength, targetAddress,
    ...
    /**
    * Create an RMAP read-modify-write reply packet using the values provided.
    *
    ...
    *
    */
    int CreateReadModifyWriteReplyPacket(U8 *pInitiatorAddress,
                                 unsigned long initiatorAddressLength,
                                 U8 targetAddress,
                                 RMAPStatus status,
                                 U16 transactionIdentifier,
    ...
    * Dispose() function).
    */
    virtual ~RMAPReadModifyWriteReplyPacket()
    {
