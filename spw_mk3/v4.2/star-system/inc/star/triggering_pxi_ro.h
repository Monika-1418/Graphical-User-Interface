...
#ifndef TRIGGERING_PXI_RO_H
#define TRIGGERING_PXI_RO_H
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setCounterInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setPortInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setTimeCodeInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setTriggerInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getCounterInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getPortInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getTimeCodeInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getTriggerInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setCounterOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setPortOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setTimeCodeOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getCounterOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getPortOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getTimeCodeOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_enableCounterAutoReload(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_disableCounterAutoReload(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getCounterAutoReloadEnabled(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_enableCounterTriggerCount(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_disableCounterTriggerCount(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getCounterTriggerCountEnabled(STAR_DEVICE_ID deviceId,
    U32 counter, U32 *pEnabled);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_enableCounterStartMode(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_disableCounterStartMode(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getCounterStartModeEnabled(STAR_DEVICE_ID deviceId,
    U32 counter, U32 *pEnabled);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_enableCounterStartStopMode(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_disableCounterStartStopMode(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getCounterStartStopModeEnabled(STAR_DEVICE_ID deviceId,
    U32 counter, U32 *pEnabled);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_enableCounterLoadZero(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_disableCounterLoadZero(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getCounterLoadZeroEnabled(STAR_DEVICE_ID deviceId,
    U32 counter, U32 *pEnabled);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setCounterReloadValue(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getCounterReloadValue(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_forceCounterReload(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getCounterValue(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_enablePortTransmitPacketMode(STAR_DEVICE_ID deviceId,
    U32 port);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_disablePortTransmitPacketMode(STAR_DEVICE_ID deviceId,
    U32 port);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getPortTransmitPacketModeEnabled(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setTriggerInputMode(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getTriggerInputMode(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_enableTrigger(STAR_DEVICE_ID deviceId,
    U32 trigger);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_disableTrigger(STAR_DEVICE_ID deviceId,
    U32 trigger);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getTriggerEnabled(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_forceTrigger(STAR_DEVICE_ID deviceId,
    U32 trigger);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setTriggerInvertMask(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getTriggerInvertMask(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_setTriggerAndMask(STAR_DEVICE_ID deviceId,
    U32 trigger, TRIGGER_TYPE type, U32 mask);
...
* \devicesSupported \ref PXIRouter
*/
int STAR_API_CC TRIGGER_PXI_ROUTER_getTriggerAndMask(STAR_DEVICE_ID deviceId,
    U32 trigger, TRIGGER_TYPE type, U32 *pMask);
