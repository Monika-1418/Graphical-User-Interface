/**
* \file triggering_pxi_if.h
*
* \brief Functions used to configure and control the triggering capabilities of the STAR-Dundee
*        PXI Interface devices. The PXI Interface devices have the following triggering resources
*        available: 4 external triggers (indexed from 0-3), 4 internal counters (indexed from 0-3),
*        4 SpaceWire ports (indexed from 1-4), 1 time-code interface (indexed as 0) and 8 internal
...
#ifndef TRIGGERING_PXI_IF_H
#define TRIGGERING_PXI_IF_H
...
*/
int STAR_API_CC TRIGGER_PXI_IF_setExtTriggerInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setCounterInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setPortInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setTimeCodeInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setTriggerInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getExtTriggerInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getCounterInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getPortInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getTimeCodeInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getTriggerInputEvents(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setExtTriggerOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setCounterOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setPortOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setTimeCodeOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getExtTriggerOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getCounterOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getPortOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getTimeCodeOutputActions(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enableExtTriggerEdgeDetectMode(STAR_DEVICE_ID deviceId,
    U32 extTrigger);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disableExtTriggerEdgeDetectMode(STAR_DEVICE_ID deviceId,
    U32 extTrigger);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getExtTriggerEdgeDetectModeEnabled(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enableExtTriggerInvert(STAR_DEVICE_ID deviceId,
    U32 extTrigger);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disableExtTriggerInvert(STAR_DEVICE_ID deviceId,
    U32 extTrigger);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getExtTriggerInvertEnabled(STAR_DEVICE_ID deviceId,
    U32 extTrigger, U32 *pEnabled);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enableExtTriggerOutput(STAR_DEVICE_ID deviceId,
    U32 extTrigger);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disableExtTriggerOutput(STAR_DEVICE_ID deviceId,
    U32 extTrigger);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getExtTriggerOutputEnabled(STAR_DEVICE_ID deviceId,
    U32 extTrigger, U32 *pEnabled);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setExtTriggerExtend(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getExtTriggerExtend(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enableCounterAutoReload(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disableCounterAutoReload(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getCounterAutoReloadEnabled(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enableCounterTriggerCount(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disableCounterTriggerCount(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getCounterTriggerCountEnabled(STAR_DEVICE_ID deviceId,
    U32 counter, U32 *pEnabled);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enableCounterStartMode(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disableCounterStartMode(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getCounterStartModeEnabled(STAR_DEVICE_ID deviceId,
    U32 counter, U32 *pEnabled);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enableCounterStartStopMode(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disableCounterStartStopMode(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getCounterStartStopModeEnabled(STAR_DEVICE_ID deviceId,
    U32 counter, U32 *pEnabled);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enableCounterLoadZero(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disableCounterLoadZero(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getCounterLoadZeroEnabled(STAR_DEVICE_ID deviceId,
    U32 counter, U32 *pEnabled);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setCounterReloadValue(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getCounterReloadValue(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_forceCounterReload(STAR_DEVICE_ID deviceId,
    U32 counter);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getCounterValue(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enablePortTransmitPacketMode(STAR_DEVICE_ID deviceId,
    U32 port);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disablePortTransmitPacketMode(STAR_DEVICE_ID deviceId,
    U32 port);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getPortTransmitPacketModeEnabled(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setTriggerInputMode(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getTriggerInputMode(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_enableTrigger(STAR_DEVICE_ID deviceId,
    U32 trigger);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_disableTrigger(STAR_DEVICE_ID deviceId,
    U32 trigger);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getTriggerEnabled(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_forceTrigger(STAR_DEVICE_ID deviceId,
    U32 trigger);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setTriggerInvertMask(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getTriggerInvertMask(STAR_DEVICE_ID deviceId,
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_setTriggerAndMask(STAR_DEVICE_ID deviceId,
    U32 trigger, TRIGGER_TYPE type, U32 mask);
...
* \devicesSupported \ref PXI
*/
int STAR_API_CC TRIGGER_PXI_IF_getTriggerAndMask(STAR_DEVICE_ID deviceId,
    U32 trigger, TRIGGER_TYPE type, U32 *pMask);
