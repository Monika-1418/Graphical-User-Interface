...
int winData[15][20][20],a=0,intensity=0,linenum=0,pixelnum=0,win_data=0,win_id=0;
int line[20],pixel[20],winData_id=0;
int bytesReceived = 0;
int rcvdata_index = 0;
int max, xl,xp;
...
void FormatData ()
{
  ...
  float colsum[20],lineintarr[20],pixintarr[20];
	  ...
	  printf("HK in Win mode\n");
		...
		wincentP[z] = centP;
          ...
          printf("\n\nMax...l-%d , p- %d, i-%d.txt\n",xl,xp,max);
 		  ...
 		  printf("\n\nWindow-%d...centl-%f , centp- %f, cpi-%d, fratio-%f, avgside-%f,sumi-%f, maxtominL-%f, maxtominP-%f, err-%d,maxLIdx-%d,minLIdx-%d,maxPIdx-%d,minPIdx-%d\n",testNum,wincentL[z],wincentP[z],wincpi[z],fratio,temp1,winsumi[z],maxL-minL, maxP-minP, flagcenterr,maxLIdx,minLIdx,maxPIdx,minPIdx);
