 ...
 *       only.  For \ref PCIe and SPLT devices please use
 ...
 *
 * \deprecated Please use the CFG_MK2_getMeasuredLinkSpeed() function instead.
 *
 ...
 *                          the measured link speed in 200 Kbits/s units, see
 *                          {@link #STAR_CFG_BRICK_MK2_LINK_SPEED_UNITS_KBPS}.
 *
 * @return  1 if the information could be obtained from the device, else 0.
 */
int STAR_API_CC CFG_BRICK_MK2_getMeasuredLinkSpeed(STAR_DEVICE_ID deviceID,
